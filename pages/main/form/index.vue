	...
	<view class="container">
		...
		<view class="form">
			...
			<u-transition :show="true" mode="fade-left">
				<view class="panel">
					...
					<view class="textarea">
						<u--textarea height="140" placeholder="支持长按粘贴您的问题" v-model="question"></u--textarea>
					</view>
		...
		<view class="tool">
			...
			<u-transition :show="true" mode="slide-up">
				<view class="grid">
					<view class="item" @click="videoAdClick">
						<view class="icon">
							<u-icon size="28"
	...
	export default {
		...
		methods: {
			onSubmitGPT() {
				...
				// })
				// var url = '/pages/main/answer/index?prompt=' + JSON.stringify(this.question);
				// console.log(url)
				// uni.redirectTo({
				//   url: url
				// });
